...
<!--colums of images with data-->
            <div class="column">
                ...
                <button class="show_reg" onclick = "downloadFile('Classic Novels\1984.pdf','1984')" a href="download.php?file=1984">>Download
            ...
            <div class="column">
                <img src="Classic Novels\lord of rings.jpg" class="modal-open hover-shadow preview" data-modal="modal2" alt="lord of rings"></img>
                    ...
                    <button class="show_reg">Download
                        <i class="fa fa-download"></i></button>
            </div>
