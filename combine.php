...
<html lang="en">
   ...
   ?>
    ...
    <head>
    <link rel="stylesheet" type="text/css" href="Newadded.css">  
...
<!--colums of images with data-->
            <div class="column">
            <img src="Saved/<?php echo $row['ImageFile']; ?>" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" alt="1984"></img>
